            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-col md:flex-row justify-between items-center">
                    <div className="mb-4 md:mb-0">
                        <h2 className="text-2xl font-bold">Next Role</h2>
                    ...
                    <div className="flex space-x-4 mt-4 md:mt-0">
                        ...
                        <a href="https://x.com/Femiloner1" className="hover:text-gray-400" aria-label="Twitter">
                        ...
                        <a href="https://www.linkedin.com/in/paul-thanksgiving-800867309/" className="hover:text-gray-400" aria-label="LinkedIn">
